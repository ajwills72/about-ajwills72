...
- **Computational modelling of categorization**. Improving the quality and impact of computational modelling in psychology. *Key paper*: Wills  & Pothos (2012). On the adequacy of current empirical evaluations of formal models of categorization. _Psychological Bulletin, 138_, 102-125. *Key resource*: catlearn - An R package for computational modelling, downloaded 17,000 times.
...
- **Decision mechanisms**. Improving theories of categorical decision-making. *Key paper*: Wills, Reimers, Stewart & McLaren (2000). Tests of the ratio rule in categorization. _Quarterly Journal of Experimental Psychology, 53A,_ 983-1011.
...
Stuart Spicer (2020), Angus Inkster (2019), Charlotte Edmunds (2016), Henrietta Roberts (2014), Fayme Yeates (2014), Fraser Milton (2006), Alice Welham (2005), Kazuhiro Goto (2004).
